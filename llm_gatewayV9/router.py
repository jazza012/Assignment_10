...
LIMITS = {
    "openai":     {"rpm": 60,   "rpd": 10000,   "tpm": 28000,    "cooldown": 0,   "max_ctx": 128000},
...
class RateState:
    ...
    def can_use(self, limits, est_tokens=0):
        ...
        tpm = sum(t for _, t in self.tokens_minute) + self.in_flight_tokens
